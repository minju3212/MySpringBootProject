...
public class StudentService {
    ...
    public StudentDTO.Response createStudent(StudentDTO.Request request) {
        ...
        // Create StudentDetail 엔티티 생성 if provided 사용자가 입력을 했을 때만
        ...
        //Student와 StudentDetail의 라이프사이클이 동일하므로 Student만 저장함
